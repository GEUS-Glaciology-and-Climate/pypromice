...
#+RESULTS:
#+begin_example
/home/kdm/local/miniconda3/envs/PROMICE_dev/lib/python3.8/site-packages/xarray/core/common.py:1123: FutureWarning: 'base' in .resample() and in Grouper() is deprecated.
...
>>> df.resample(freq="3s", offset="2s")
  ...
  grouper = pd.Grouper(
/home/kdm/local/miniconda3/envs/PROMICE_dev/lib/python3.8/site-packages/xarray/core/nanops.py:142: RuntimeWarning: Mean of empty slice
...
# t
clf()
ax = py['t'].plot(linewidth=3, label='v4')
idl['AirTemperature(C)'].plot(ax=ax, label='v3')
legend()

# dswr
clf()
ax = py['dswr'].plot(linewidth=3, label='v4')
