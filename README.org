...
- [[#compare-python--idl][Compare Python & IDL]]
  - [[#graphic][Graphic]]
  - [[#columns][Columns]]
  - [[#load-both-to-dfs][Load both to dfs]]
...
ds['tilt_x'] = ds['tilt_x'].interpolate_na(dim='time', method='linear')
ds['tilt_y'] = ds['tilt_y'].interpolate_na(dim='time', method='linear')
...
emissivity = 0.97
ds['t_surf'] = ((ds['ulr'] - (1 - emissivity) * ds['dsr']) / emissivity / 5.67e-8)**0.25 - T_0
...
df = pd.read_csv("./data/L3/EGP/EGP-raw_hour.csv", index_col=0, parse_dates=True)\
       .drop(columns='rh')\
       .rename(columns={'rh_cor':'rh'})
...
dd
# print(diff_pct.describe().T)
# diff_with_errors_gt_1pct = diff_pct.describe().where(abs(diff_pct.describe()) > 1).T.drop(columns="count").dropna(how='all', axis='rows')
# print(diff_with_errors_gt_1pct)
# for c in diff.columns:
#     diff[c] = diff[c].round(3).astype(np.str) + " (" + diff_pct[c].round(3).astype(np.str) + ")"
...
cc     56.76984 13.22601 42.00000 46.50000 54.50000 68.50000 72.61905
dlr     0.13073  0.32023  0.00000  0.00000  0.00000  0.00000  0.78441
dsr     0.59263  1.45164  0.00000  0.00000  0.00000  0.00000  3.55577
fan_dc  0.10814  0.26490  0.00000  0.00000  0.00000  0.00000  0.64886
rh      0.13182  0.32288  0.00000  0.00000  0.00000  0.00000  0.79090
t_1    -0.43403  1.06315 -2.60417  0.00000  0.00000  0.00000  0.00000
t_2    -0.41871  1.02564 -2.51229  0.00000  0.00000  0.00000  0.00000
t_surf  9.20204  5.09490  0.84535  6.85481 10.50571 12.13417 15.04065
ulr     0.09113  0.22322  0.00000  0.00000  0.00000  0.00000  0.54678
usr     0.18735  0.45892  0.00000  0.00000  0.00000  0.00000  1.12413
wdir   -2.08797  4.17593 -8.35187 -2.08797  0.00000  0.00000  0.00000
<ipython-input-339-012012ac3340>:6: FutureWarning: The pandas.datetime class is deprecated and will be removed from pandas in a future version. Import from datetime module instead.
  return pd.datetime(int(y),int(m),int(d),int(h))
#+end_example
|        |       mean |       std |       min |      25% |     50% |     75% |       max |
|--------+------------+-----------+-----------+----------+---------+---------+-----------|
| cc     | 56.7698    | 13.226    | 42        | 46.5     | 54.5    | 68.5    | 72.619    |
| dlr    |  0.130735  |  0.320234 |  0        |  0       |  0      |  0      |  0.78441  |
| dsr    |  0.592629  |  1.45164  |  0        |  0       |  0      |  0      |  3.55577  |
| fan_dc |  0.108143  |  0.264895 |  0        |  0       |  0      |  0      |  0.648858 |
| rh     |  0.131816  |  0.322883 |  0        |  0       |  0      |  0      |  0.790898 |
| t_1    | -0.434028  |  1.06315  | -2.60417  |  0       |  0      |  0      |  0        |
| t_2    | -0.418715  |  1.02564  | -2.51229  |  0       |  0      |  0      |  0        |
| t_surf |  9.20204   |  5.0949   |  0.845351 |  6.85481 | 10.5057 | 12.1342 | 15.0407   |
| ulr    |  0.0911296 |  0.223221 |  0        |  0       |  0      |  0      |  0.546777 |
| usr    |  0.187355  |  0.458924 |  0        |  0       |  0      |  0      |  1.12413  |
| wdir   | -2.08797   |  4.17593  | -8.35187  | -2.08797 |  0      |  0      |  0        |
:END:
