...
Coordinates:
  ,* time         (time) datetime64[ns] 2016-05-01T14:30:00 ... 2016-07-19T17:...
Data variables:
    rec          (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    min_y        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    p            (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t            (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_hygroclip  (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    rh           (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    wspd         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    wdir         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    wd_std       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    dswr         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    uswr         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    dlwr         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    ulwr         (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_rad        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_boom       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_boom_q     (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_stake      (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_stake_q    (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_ice        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_1        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_2        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_3        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_4        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_5        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_6        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_7        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_i_10       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    tilt_x       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    tilt_y       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_time     (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_lat      (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_lon      (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_alt      (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_giodal   (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_geounit  (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_q        (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_numsat   (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    gps_hdop     (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    t_logger     (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    fan_dc       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    batt_v_ss    (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    batt_v       (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
    z_ice_corr   (time) float64 dask.array<chunksize=(10847,), meta=np.ndarray>
Attributes:
    station_id:          EGP
    field_delimiter:     ,
    nodata:              -999
...
|-------------+-----------+------------+---------+-----------------------------------------|
| tilt_x      |       -40 |         40 |         | [[./IDL/AWSdataprocessing_v3.pro#L390]] |
| tilt_y      |       -40 |         40 |         |                                         |
| tilt_x      |       -30 |         30 |         | [[./IDL/AWSdataprocessing_v3.pro#L675]] |
| tilt_y      |       -30 |         30 |         |                                         |
| p           |       650 |       1100 |         |                                         |
