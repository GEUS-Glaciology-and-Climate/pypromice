...
| z_boom      | snow_height_at_boom                    | Snow height                              | m                   |            1 |          0 |                                                                          |
| z_boom_q    | snow_height_at_boom_quality            | Snow height (quality)                    |                     |            1 |          0 |                                                                          |
| z_stake     | snow_height_at_stake                   | Surface height                           | m                   |            1 |          0 |                                                                          |
| z_stake_q   | snow_height_at_stake_quality           | Surface height (quality)                 |                     |            1 |          0 |                                                                          |
| z_ice       | ice_height                             | Ice height                               | m                   |            1 |          0 |                                                                          |
...
| gps_time    | gps_time                               | GPS time                                 | s                   |            1 |          0 |                                                                          |
