...
from pypromice.bufr.real_time_utilities import get_latest_data
...
class GetLatestDataTestCase(unittest.TestCase):
    def get_data(self) -> pd.DataFrame:
        ...
        csv_lines = [
            "time,p_i,t_i,rh_i,wspd_i,wdir_i,gps_lat,gps_lon,gps_alt,z_boom_cor_u",
