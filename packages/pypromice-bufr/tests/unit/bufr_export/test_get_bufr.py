...
from pypromice.bufr.bufr_utilities import BUFRVariables
from pypromice.bufr.get_bufr import (
    get_station_positions,
    get_bufr_variables,
    REQUIRED_KEYS,
    get_bufr,
)
from pypromice.bufr.station_configuration import StationConfiguration
...
MOCK_BASE_STR = "pypromice.bufr.get_bufr.{}"
